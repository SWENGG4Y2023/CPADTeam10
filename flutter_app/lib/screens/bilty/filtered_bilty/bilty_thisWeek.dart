...
class BiltyFilteredWeek extends StatefulWidget {
  const BiltyFilteredWeek({Key? key}) : super(key: key);

  @override
  State<BiltyFilteredWeek> createState() => _BiltyFilteredWeekState();
}

class _BiltyFilteredWeekState extends State<BiltyFilteredWeek> {
  late Future<dynamic> futureBilty;
  final BackendAPI backendAPI = BackendAPI();
  @override
  void initState() {
    futureBilty = backendAPI.getThisWeekBilty();
    super.initState();
  }
