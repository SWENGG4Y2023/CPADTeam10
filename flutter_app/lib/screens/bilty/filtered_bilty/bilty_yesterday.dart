...
class BiltyFilteredYesterday extends StatefulWidget {
  const BiltyFilteredYesterday({Key? key}) : super(key: key);

  @override
  State<BiltyFilteredYesterday> createState() => _BiltyFilteredYesterdayState();
}

class _BiltyFilteredYesterdayState extends State<BiltyFilteredYesterday> {
  late Future<dynamic> futureBilty;
  final BackendAPI backendAPI = BackendAPI();
  @override
  void initState() {
    futureBilty = backendAPI.getYesterdayBilty();
    super.initState();
  }
